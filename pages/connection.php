...
<body>
    ...
    <main>
        ...
        <div id="Box_general">
            ...
            <form method="POST" action="../php/traitement_connection.php">
                <input id="mail" name="mail" class="input-text-base" type="email" placeholder="Email" required>
                <input id="mot_de_passe" name="mot_de_passe" class="input-text-base" type="password" placeholder="Mot de passe" required>
                ...
                <input type="submit" class="valider" value="Connection">
                <a href="../pages/inscription.php" class="nostyle">J'ai pas de compte compte</a>
            </form>
        </div>
